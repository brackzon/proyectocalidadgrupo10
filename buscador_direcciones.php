...
<html>
  ...
  <body>
    ...
    <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBkfRsO7eHz4JkT_w3EjlgZbWIO3f7WAa8&callback=initMap&libraries=places&v=weekly"
      defer
    ></script>
    ...
    <script>
      ...
      function initMap() {
        const map = new google.maps.Map(document.getElementById("map"), {
          center: { lat: -11.9693692, lng: -77.0589891 },
          zoom: 13,
  ...
  sessionStorage.setItem('pac-input', buscador.value);
...
window.addEventListener('load', function() {
  ...
  if (sessionStorage.getItem('pac-input')) {
    buscador.value = sessionStorage.getItem('pac-input');
  }
