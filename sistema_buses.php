...
<html lang="es">
  ...
  <body>
      ...
      <div class="container-fluid text-black menu" style="background-color: #BEE7F4" id="cont_menu">
          ...
          <div class="container-fluid">
            ...
            <div class="container fluid">
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link item" href="pasajeros.php"><strong>Pasajero</strong></a>
                </li> 
                <li class="nav-item">
                  <a class="nav-link" href="usuario.php"><strong>Usuario</strong></a>
                </li> 
                <li class="nav-item">
                  <a class="nav-link item" href="conductor.php"><strong>Conductor</strong></a>
                </li> 
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link item" href="bus.php"><strong>Buses</strong></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link item" href="calcular_distancia_tiempo.php"><strong>Distancia y tiempo</strong></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link item" href="buscador_direcciones.php"><strong>Ubicación</strong></a>
                </li>
                <li class="nav-item">
      ...
      <div class="container-fluid" id="contenedor_fondo">
          ...
          <div id="contenido_principal">
            ...
            <div class="imagen">
              <img src="images/bus.png" alt="bus.png" class="imagen">
            </div>
